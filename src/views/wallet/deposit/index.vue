<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否归集：0-未归集，1-已归集" prop="isCollect">
        <el-input
          v-model="queryParams.isCollect"
          placeholder="请输入是否归集：0-未归集，1-已归集"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['wallet:deposit:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['wallet:deposit:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['wallet:deposit:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="depositList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否归集：0-未归集，1-已归集" align="center" prop="isCollect" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="区块号" prop="blockNumber">
          <el-input v-model="form.blockNumber" placeholder="请输入区块号" />
        </el-form-item>
        <el-form-item label="是否归集：0-未归集，1-已归集" prop="isCollect">
          <el-input v-model="form.isCollect" placeholder="请输入是否归集：0-未归集，1-已归集" />
        </el-form-item>
        <el-form-item label="创建时间" prop="ctime">
          <el-date-picker clearable
            v-model="form.ctime"
...
<script>
import { listDeposit, getDeposit, delDeposit, addDeposit, updateDeposit } from "@/api/wallet/deposit";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        blockNumber: [
          { required: true, message: "区块号不能为空", trigger: "blur" }
        ],
        status: [
          { required: true, message: "状态不能为空", trigger: "change" }
        ],
        isCollect: [
          { required: true, message: "是否归集：0-未归集，1-已归集不能为空", trigger: "blur" }
        ],
        chainType: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('wallet/deposit/export', {
        ...this.queryParams
